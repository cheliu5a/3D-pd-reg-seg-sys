...
def to_categorical(y, num_classes): #tensor
...
def main(args):
    ...
    try:
        ...
        print("load_state_dict success")
        log_string('Use pretrain model')
    except:
        log_string('No existing model, starting training from scratch...')
        start_epoch = 0
        classifier = classifier.apply(weights_init)
        print("weights_init success")
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        print("bn_momentum_adjust success")
        ...
        for i, (points, label, target) in tqdm(enumerate(trainDataLoader), total=len(trainDataLoader), smoothing=0.9):
            ...
            print("#")
            seg_pred, trans_feat = classifier(points, to_categorical(label, num_classes)) # problem
            print("###")
        ...
        if (test_metrics['inctance_avg_iou'] >= best_inctance_avg_iou):
            ...
            torch.save(state, savepath) # 最优性能，保存模型
