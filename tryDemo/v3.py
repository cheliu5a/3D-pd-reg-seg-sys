...
class MainWindow(QWidget):
    ...
    def draw(self, x, y, z, name, file_dir, color=None): # name:pred
        ...
        if color is None:
            ...
            colors = [
                'red', 'blue', 'green', 'yellow', 'orange', 'tan', 'orangered', 'forestgreen', 'coral', 'aqua',
...
class PartNormalDataset(Dataset):
    def __init__(self, img_root, target_root, npoints=2500, normal_channel=False):
